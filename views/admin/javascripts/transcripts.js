...
(function ($) {
    Omeka.ItemTranscript.setUpBlocks = function(blockFormUrl) {
    ...
    Omeka.ItemTranscript.themeConfig = function() {
        if ($('#theme').val() === '') {
    ...
    Omeka.ItemTranscript.setUpItemsSelect = function (itemOptionsUrl) {
        /*
        ...
        $('#item-select').on('click', '.select-item', function (event) {
            event.preventDefault();
            Omeka.ItemTranscript.loadItemOptionsForm(
    ...
    Omeka.ItemTranscript.setUpAttachments = function (attachmentUrl) {
        ...
        attachmentPanel.dialog({
            ...
            open: function () {
                ...
                $(window).on('resize.ItemTranscript', function () {
                    refreshDialog();
                });
            },
            beforeClose: function () {
                $('body').css('overflow', 'inherit');
                $(window).off('resize.ItemTranscript');
        ...
        $('#block-container').on('click', '.edit-attachment', function (event) {
            ...
            Omeka.ItemTranscript.loadItemOptionsForm(getAttachmentData(attachment, true));
            $(document).trigger('exhibit-builder-select-item');
