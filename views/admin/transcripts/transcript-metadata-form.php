<form id="transcript-metadata-form" method="post" class="transcript-builder">
    ...
    <fieldset>
        ...
        <div class="field">
            ...
            <div class="five columns omega inputs">
                <?php echo $this->formText('credits', $transcript->credits); ?>
            </div>
        </div>
        <div class="field">
            <div class="two columns alpha">
            ...
            <div class="five columns omega inputs">
                <?php echo $this->formTextarea('description', $transcript->description, array('rows'=>'8','cols'=>'40')); ?>
            </div>
        </div>
        <div class="field">
            <div class="two columns alpha">
            ...
            <div class="five columns omega inputs">
                <?php $transcriptTagList = join(', ', pluck('name', $transcript->Tags)); ?>
                <?php echo $this->formText('tags', $transcriptTagList); ?>
            </div>
        </div>
        <div class="field">
            <div class="two columns alpha">
            ...
            <div class="five columns omega inputs">
                <?php $values = array('' => __('Current Public Theme')) + transcript_builder_get_themes(); ?>
                <?php echo get_view()->formSelect('theme', $transcript->theme, array(), $values); ?>
    ...
    <fieldset>
        ...
        <div id="pages-list-container">
            ...
            <?php else: ?>
                ...
                <?php echo common('page-list', array('transcript' => $transcript), 'transcripts'); ?>
            <?php endif; ?>
        </div>
        <div id="page-add">
    ...
    <section class="three columns omega">
        <div id="save" class="panel">
            ...
            <?php if ($transcript->exists()): ?>
                <?php echo transcript_builder_link_to_transcript($transcript, __('View Public Page'), array('class' => 'big blue button', 'target' => '_blank')); ?>
